    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            LazyHorizontalGrid (
                ...
                horizontalArrangement = Arrangement.spacedBy(16.dp), // <--- 增大水平间距，让卡片更分散
                modifier = Modifier
                    .height(270.dp).background(Color.Transparent) // 占据 Column 剩下的所有垂直空间，实现滚动
            ) {
